...
import { useMyBoardsPagination } from "./hook";
import { IMyBoardsPagination } from "./types";

export const MyBoardsPagination = ({ lastPage }: IMyBoardsPagination) => {
    const { startPage, currentPage, onClickPrevPage, onClickNextPage, onClickPage } =
        useMyBoardsPagination({ lastPage });
