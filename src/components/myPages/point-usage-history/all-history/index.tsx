            ...
            <div className={styles.boards_wrapper}>
                <div className={styles.board_table}>
                    <div className={styles.board_header}>
                        <div className={styles.board_header_num}>날짜</div>
                        <div className={styles.board_header_title}>내용</div>
                        <div className={styles.board_header_writer}>거래 및 충전 내역</div>
                        <div className={styles.board_header_regDate}>잔액</div>
                    </div>
